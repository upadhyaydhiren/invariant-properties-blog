...
/**
 * Implementation of TermFinderRestClient.
 * 
 * @author Bear Giles <bgiles@coyotesong.com>
 */
public class TermFinderRestClientImpl extends AbstractFinderRestClientImpl<Term> implements TermFinderRestClient {
     ...
     * @param termResource
     */
    public TermFinderRestClientImpl(final String resource) {
        super(resource, Term.class, Term[].class);
    }

    /**
     * @see com.invariantproperties.sandbox.student.webservice.client.TermFinderRestClient#getAllTerms()
     */
    @Override
    ...
    /**
     * @see com.invariantproperties.sandbox.student.webservice.client.TermFinderRestClient#getTerm(java.lang.String)
     */
    @Override
