...
public class SectionRestClientImplTest {
    ...
    public void testGetAllSectionsEmpty() {
        SectionRestClient client = new SectionRestClientMock(200, new Section[0]);
    ...
    public void testGetAllSectionsNonEmpty() {
        ...
        SectionRestClient client = new SectionRestClientMock(200, new Section[] { section });
        Section[] results = client.getAllSections();
    ...
    public void testCreateSection() {
        ...
        SectionRestClient client = new SectionRestClientMock(Response.Status.CREATED.getStatusCode(), expected);
