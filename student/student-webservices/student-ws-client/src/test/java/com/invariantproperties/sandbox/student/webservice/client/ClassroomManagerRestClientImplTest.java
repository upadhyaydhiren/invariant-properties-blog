...
/**
 * Unit tests for ClassroomManagerRestClientImpl. Remember that we want to test
 * the behavior, not the implementation.
 * 
 * @author Bear Giles <bgiles@coyotesong.com>
 */
public class ClassroomManagerRestClientImplTest {
    ...
    public void testCreateClassroom() {
        ...
        ClassroomManagerRestClient client = new ManagerClassroomMock(Response.Status.CREATED.getStatusCode(), expected);
    ...
    public void testCreateClassroomError() {
        ClassroomManagerRestClient client = new ManagerClassroomMock(500, null);
    ...
    public void testUpdateClassroom() {
        ...
        expected.setName(NAME);
        ClassroomManagerRestClient client = new ManagerClassroomMock(200, expected);
    ...
    public void testUpdateClassroomMissing() {
        ClassroomManagerRestClient client = new ManagerClassroomMock(404, null);
    ...
    public void testDeleteClassroom() {
        ...
        ClassroomManagerRestClient client = new ManagerClassroomMock(204, null);
...
/**
 * ClassroomManagerRestClientImpl extended to mock jersey API. This class
 * requires implementation details.
 */
class ManagerClassroomMock extends ClassroomManagerRestClientImpl {
    ...
    ManagerClassroomMock(int status, Object results) {
        super(RESOURCE);
        this.status = status;
