...
public class StudentResourceTest {
	...
	public void testFindAllStudentsFailure() {
		final StudentService service = Mockito.mock(StudentService.class);
		when(service.findAllStudents()).thenThrow(
	...
	public void testGetStudentMissing() {
		final StudentService service = Mockito.mock(StudentService.class);
		when(service.findStudentByUuid(david.getUuid())).thenThrow(
				new ObjectNotFoundException(david.getUuid()));
	...
	public void testCreateStudentFailure() {
		...
		final StudentService service = Mockito.mock(StudentService.class);
		when(service.createStudent(req.getName(), req.getEmailAddress())).thenThrow(
				new UnitTestException());
	...
	public void testUpdateStudent() {
		...
		final StudentService service = Mockito.mock(StudentService.class);
		when(service.findStudentByUuid(expected.getUuid())).thenReturn(expected);
		when(service.updateStudent(expected, req.getName(), req.getEmailAddress()))
				.thenReturn(updated);

		final StudentResource resource = new StudentResource(service);
		final Response response = resource.updateStudent(expected.getUuid(),
				req);
	...
	public void testUpdateStudentFailure() {
		...
		final StudentService service = Mockito.mock(StudentService.class);
		when(service.updateStudent(expected, req.getName(), req.getEmailAddress())).thenThrow(
				new UnitTestException());
	...
	public void testDeleteStudentMissing() {
		...
		doThrow(new ObjectNotFoundException(expected.getUuid())).when(service)
				.deleteStudent(expected.getUuid());
